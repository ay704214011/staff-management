...
export default class ProductionOutput extends Component {
    state = {
      productionSizeList: [{
        label: '3MM',
        value: '3mm'
    ...
    render () {
      const footerColumnGroup = 
        ...
        <div className="section-container">
          <p className="section-title">Production output details </p>
		     <hr/>
        <div className="form-row">
          ...
          <form class="form-inline form-group">
	        ...
	        <label for="weight" className="sr-only">Weight (in ton) </label>
            <input type="number" className="form-control" id="weight" placeholder="Quantity (in ton)"/>
		    </div>
